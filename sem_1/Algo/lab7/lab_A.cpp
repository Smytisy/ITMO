...
//
//void task_C() {
//    ifstream fin(R"(addition.in)");
//    ofstream fout(R"(addition.out)");
//
//    AVL_tree t;
//    vector<int> values;
//
...
//    for (int i = 0; i < n; i++) {
//        input[i + 1].resize(3);
//        fin >> input[i + 1][0] >> input[i + 1][1] >> input[i + 1][2];
//        //t.insert_arrays(x, left, right, i);
//        values[i] = input[i + 1][0];
//    }
//    t.insert_arrays(input);
//
//    vector<vector<int>> output;
//    output.resize(t.get_size() + 1);
...
//    /*
//
//    t.get_tree_array(output);
//    fout << t.get_size() << endl;
//    for (int i = 1; i < n + 1; i++) {
...
//    /*
//    for (int i = 0; i < n; i++) {
//        fout << t.get_balance(values[i]) << endl;
//    }
//    */
//
//    fin.close();
